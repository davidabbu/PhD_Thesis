...
\begin{figure}[]
\includegraphics[width=0.4\columnwidth]{Figs/Aging_Threshold/cascade.pdf}
...
\begin{figure}
\includegraphics[width=0.4\columnwidth]{Figs/Aging_Threshold/GRAPH_PLOT.pdf}
...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{Figs/Aging_Threshold/EVO_MOD.pdf}
...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{Figs/Aging_Threshold/time_steady.pdf}
