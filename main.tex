...
\titlepage % Output the title page
	...
	{ % Title(s) and author(s)
		...
		{\Huge\bfseries Aging in the idealista model for complex systems housing \par} % Book title
		\vspace{16pt} % Vertical whitespace
		{\LARGE PhD thesis \par} % Subtitle
		\vspace{24pt} % Vertical whitespace
		{\huge\bfseries David Abella Bujalance \par} % Author name
	}
...
\noindent Copyright \copyright\ 2024 David Abella \\ % Copyright notice

\noindent \textsc{Published by No one}\\ % Publisher
...
\noindent \textit{First printing, June 2024} % Printing/edition date
