...
\hypersetup{
	pdftitle={Aging and memory effects in social and economic dynamics}, % Title field
	pdfauthor={David Abella}, % Author field
	pdfsubject={Aging and memory effects in social and economic dynamics}, % Subject field
	pdfkeywords={Aging, memory, social, economic, dynamics, complex, networks, stochastic, modeling, housing market, segregation, segmentation, consensus, spread, complex, contagion}, % Keywords
...
\addcontentsline{toc}{chapter}{List of publications} % Add a List of publications heading to the table of contents
...
\addcontentsline{toc}{chapter}{Contents} % Add a Table of contents heading to the table of contents

\listoffigures % Output the list of figures, comment or remove this command if not required

\addcontentsline{toc}{chapter}{List of figures} % Add a List of figures heading to the table of contents
...
\addcontentsline{toc}{chapter}{List of acronyms} % Add a List of acronyms heading to the table of contents
...
%----------------------------------------------------------------------------------------
\mainmatter
\chapterimage{Images/Cover_Intro_2-compressed.pdf}
...
%	MODELS
%----------------------------------------------------------------------------------------
\chapterimage{Images/Traject-compressed.pdf}
\chapterspaceabove{6.75cm}
\chapterspacebelow{7.25cm}
...
\printbibliography\addcontentsline{toc}{chapter}{\textcolor{ocre}{Bibliography}} % Add a Bibliography heading to the table of contents
