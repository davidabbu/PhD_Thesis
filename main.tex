...
\chapter{\label{ch:Aging in binary state dynamics: The threshold model} Aging in binary state dynamics: The threshold model}
...
\chapter{\label{ch:Ordering dynamics in the Symmetrical Threshold model} Ordering dynamics in the Symmetrical Threshold model}
\input{Chapters/Aging_STM.tex}

%----------------------------------------------------------------------------------------
%	AGING IN THE SYMMETRICAL THRESHOLD MODEL
%----------------------------------------------------------------------------------------
\chapterimage{Images/STMA2.pdf}
\chapterspaceabove{6.75cm}
\chapterspacebelow{7.25cm}

\chapter{\label{ch:Aging implications in the Symmetrical Threshold model} Aging implications in the Symmetrical Threshold model}
...
%------------------------------------------------
%	APPENDIX A: Master equation with aging 
%------------------------------------------------
